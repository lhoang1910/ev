package com.insurance.domain.utils;
...
public final class SerializerUtils {
    ...
    public static EventStoreEntity[] deserializeEventsFromJsonBytes(final byte[] jsonBytes) {
        try {
            return objectMapper.readValue(jsonBytes, EventStoreEntity[].class);
        } catch (IOException e) {
            throw new RuntimeException(e.getMessage(), e);
        }
    }
